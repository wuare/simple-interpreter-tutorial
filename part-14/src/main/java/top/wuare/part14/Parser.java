...
public class Parser {
    ...
    private List<AST> declarations() {
        ...
        while (true) {
            ...
            else if (curToken.getType() == Token.PROCEDURE) {
                eat(Token.PROCEDURE);
